      ...
      <header className="py-4 px-4 sm:px-6 border-b border-[rgba(255,255,255,0.04)]">
        <nav className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <Link href="/admin/analytics" title="Analytics" style={{ fontSize: 12, padding: '6px 10px', borderRadius: 8, background: 'rgba(156,175,136,0.1)', color: '#7a9166', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4, whiteSpace: 'nowrap' }}>
              <span>📊</span><span className="hidden md:inline"> Analytics</span>
            </Link>
            <Link href="/admin/blog" title="Blog Manager" style={{ fontSize: 12, padding: '6px 10px', borderRadius: 8, background: 'rgba(156,175,136,0.1)', color: '#7a9166', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4, whiteSpace: 'nowrap' }}>
              <span>✍️</span><span className="hidden md:inline"> Blog</span>
            </Link>
